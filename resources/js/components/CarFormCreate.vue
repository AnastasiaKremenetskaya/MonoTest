<template>
    <div class="CarFormCreate">
        <form class="form form-horizontal" @submit.prevent="createCar">

            <label class="col-sm-1 control-label">Клиент</label>

            <div v-if="user" class="col-sm-12">
                <select v-model="car.user_id" class="custom-select" name="user_id" id="user_id">
